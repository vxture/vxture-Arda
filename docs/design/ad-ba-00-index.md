...
| `ba-41` | 数据接入 功能设计 | 功能 | 待设计 |
| `ba-42` | 资产与元数据 功能设计 | 功能 | 待设计 |
| `ba-43` | 数据标准 功能设计 | 功能 | 待设计 |
| `ba-44` | 主数据 功能设计 | 功能 | 待设计 |
| `ba-45` | [数据质量 功能设计](ad-ba-45-quality.md) | 功能 | 完成（样板 · 待评审） |
| `ba-46` | 数据血缘 功能设计 | 功能 | 待设计 |
| `ba-47` | 数据安全 功能设计 | 功能 | 待设计 |
| `ba-48` | 数据服务 功能设计 | 功能 | 待设计 |
| `ba-49` | 数据生命周期 功能设计 | 功能 | 待设计 |
